...
//
// Mockup implementation of the backup restore client.
...
type BackupMockup struct {
    ...
    backupRestoreMgr     backup.Manager
}

func NewBackupMockup() Backup {
    ...
    var backupRestoreMgr = backup.NewManager(networkProvider, clusterProvider, nodeProvider, appDescProvider, 
    ...
    return &BackupMockup{
        ...
        accessProvider,passwordProvider,backupRestoreMgr}
}

func (mockup *BackupMockup) ClearMockup() {
...
func (mockup *BackupMockup) InitMockup() {
    mockup.ClearMockup()
...
func (mockup *BackupMockup) Export(component string) (*entities.BackupRestore, derrors.DaishoError) {
    return mockup.backupRestoreMgr.Export(component)
}


func (mockup *BackupMockup) Import(component string, entity *entities.BackupRestore )( derrors.DaishoError){
    return mockup.backupRestoreMgr.Import(component,entity)
}